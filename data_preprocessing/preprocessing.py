...
class Preprocessor:
    ...
    def is_null_present(self, data):
        ...
        try:
            ...
            if self.null_present:  # write the logs to see which columns have null values
                ...
                dataframe_with_null.to_csv(os.path.join(self.config['data_preprocessing']['preprocessed_data_dir'],self.config['data_preprocessing']['null_values_csv']))  # storing the null column information to file
    ...
    def impute_missing_values(self, data):
        ...
        self.data = data
        try:
            imputer = KNNImputer(n_neighbors=self.config['data_preprocessing']['KNNImputer']['n_neighbors'], weights=self.config['data_preprocessing']['KNNImputer']['weights'], missing_values=np.nan)
